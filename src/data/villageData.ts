...
export const defaultVillageData: VillageData = {
  ...
  prokerKKN: [
    {
      id: 1,
      judul: "Pemetaan & WebGIS Dusun Dawang",
      kategori: "Proker Utama",
      emoji: "🗺️",
      deskripsi: "Pembuatan peta cetak administrasi Dusun Dawang serta pengembangan WebGIS StoryMap interaktif berbasis QR Code.",
      anggota: ["Christopher Daniel Simbolon", "Satria Rikhan Ganendra"],
      tanggal: "Januari 2026",
      durasi: "4 Minggu",
      output: "Peta Cetak A0 + Website WebGIS StoryMap",
      foto: [],
      video: ""
    },
    {
      ...
      kategori: "Proker Utama",
      emoji: "🏥",
      deskripsi: "Pendampingan rutin posyandu balita & lansia, sosialisasi Perilaku Hidup Bersih & Sehat (PHBS), serta pemeriksaan kesehatan.",
    ...
    },
    {
      ...
      kategori: "Proker Utama",
      emoji: "💻",
      deskripsi: "Pelatihan fotografi produk HP, pembuatan akun Google Maps Business, serta pembuatan kemasan menarik untuk UMKM Dusun Dawang.",
      anggota: ["Hafshah Afifah Khairunnisa", "Gregorius Dennis A"],
      tanggal: "Januari 2026",
      durasi: "2 Minggu",
    ...
    },
    {
      ...
      kategori: "Proker Utama",
      emoji: "🌱",
      deskripsi: "Penanaman bibit tanaman buah & pohon peneduh di sepanjang jalan dusun, serta sosialisasi pemilahan sampah organik.",
      anggota: ["Ferdy Adinata Prabaswara", "Adhiimu Ayunda Artha Wijaya"],
      tanggal: "Januari 2026",
      durasi: "3 Minggu",
      output: "Bibit Ditanam + Tong Sampah Organik",
      foto: [],
      video: ""
    },
    {
      ...
      anggota: ["Pashya Syachrila", "Dwiatma Meilany Putri"],
      tanggal: "Januari 2026",
      durasi: "4 Minggu",
    ...
    {
      id: 7,
      judul: "Mini Pabrik di SD Blongkeng",
      kategori: "Proker Individu",
      emoji: "🏭",
      deskripsi: "Program individu pengenalan konsep produksi sederhana kepada siswa SD Negeri Blongkeng melalui simulasi mini pabrik interaktif.",
      anggota: ["Pashya Syachrila"],
      tanggal: "Januari 2026",
      durasi: "1 Minggu",
      output: "Modul Edukasi Mini Pabrik SD",
      foto: [],
      video: ""
    }
  ],
