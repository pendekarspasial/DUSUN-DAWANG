...
import {
  ...
  BookOpen, FileText, ListOrdered, Target, Users, ZoomIn, ZoomOut, Download,
} from 'lucide-react';
      ...
      case 'cover':
        return (
          <div className="text-center space-y-5 py-8 px-2">
            ...
            {proker.laporanUrl && (
              <a
                href={getAssetUrl(proker.laporanUrl)}
                download
                onClick={(e) => e.stopPropagation()}
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-dawang-clay/20 border border-dawang-clay/50 text-dawang-clayLight hover:bg-dawang-clay hover:text-white transition-all text-xs font-bold"
              >
              ...
              <div className="pt-4 mt-4 border-t border-white/10 flex items-center justify-between text-xs">
                ...
                {proker.laporanUrl && (
                  <a
                    ...
                    download
                    onClick={(e) => e.stopPropagation()}
                    className="p-1.5 rounded-lg bg-white/10 hover:bg-white/20 text-dawang-sandMuted hover:text-white border border-white/15 transition-all flex items-center justify-center"
                    title="Unduh Laporan"
                  >
                    <Download className="w-3.5 h-3.5" />
                  </a>
